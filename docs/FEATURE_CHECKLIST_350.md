# چک‌لیست ۳۵۰ قابلیت — وضعیت واقعی در نسخهٔ 1.5.1
...
| L1 | لایسنس آنلاین (Worker مالک)، ذخیرهٔ نتیجه، بررسی هر ۲۴ ساعت، قفل بدون لایسنس | ✅ | `services/license.py`; T: `test_v1_5_license_setup.py` (۹ آزمون); اسموک `smoke-v1_5.js` |
