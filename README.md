...
## ✨ امکانات (نسخهٔ 1.2.5 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.5 (فعلی)** — خوددرمانی اسکیمای پایگاه داده در شروع (ستون‌های غایب از نسخه‌های قدیمی اضافه می‌شوند)؛ رفع کرش `units.allow_decimal`؛ پیام خطای خوانا در لانچر ویندوز.
