...
## ✨ امکانات (نسخهٔ 1.2.3 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.3 (فعلی)** — رفع ریشه‌ای تشخیص پایتون در سازندهٔ نصب‌کننده (باگ نقل‌قول PowerShell 5.1) + خودتشخیصی با گزارش دلیل رد هر مسیر.
