...
## ✨ امکانات (نسخهٔ 1.4.0 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.4.0 (فعلی)** — حسابداری دوطرفه کامل (دفتر روزنامه/کل، تراز، سود و زیان، ترازنامه، هزینه‌ها، چک، تأمین‌کننده، شیفت صندوق) با ثبت خودکار از فروش و خرید؛ داشبورد و صندوق با طراحی نئون/شیشه‌ای؛ شناسایی خودکار بارکدخوان USB.
