...
## ✨ امکانات (نسخهٔ 1.2.1 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.1 (فعلی)** — رفع خطای پارس اسکریپت‌های ساخت نصب‌کنندهٔ ویندوز (BOM UTF-8) و جای اشتباه `MinVersion` در `setup.iss`.
