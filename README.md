...
## ✨ امکانات (نسخهٔ 1.6.0 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.6.0 (فعلی)** — نگه‌داشتن تا ۱۰ فاکتور در نوار پایین صندوق (F6)، دکمهٔ خروج با بکاپ، تمام‌صفحه/ریسپانسیو، جینگل خوش‌آمد و صداهای مجزا، لایسنس آفلاین تا تاریخ انقضا + ZIP رمزنگاری‌شده هنگام قفل، اپ اندروید APK با جفت‌سازی QR و همگام‌سازی آفلاین.
