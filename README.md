...
## ✨ امکانات (نسخهٔ 1.4.2 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.4.2 (فعلی)** — رفع خطای PyInstaller `not enough values to unpack (expected 3, got 2)` در app.spec (TOC صحیح برای فایل‌های pywebview).
