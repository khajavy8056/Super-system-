...
| **موبایل / اندروید** | اپ اندروید (`SupermarketMobile-<ver>.apk`) با تمام بخش‌ها در UI موبایلی، جفت‌سازی با QR از تنظیمات ویندوز، کار آفلاین و همگام‌سازی خودکار دوطرفه در LAN بدون اینترنت؛ همچنان PWA در مرورگر ([`docs/MOBILE.md`](docs/MOBILE.md)) |
