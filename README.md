...
## ✨ امکانات (نسخهٔ 1.5.1 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.5.1 (فعلی)** — لودینگ ۴۵ دقیقه‌ای فقط داخل ویزارد (ورودهای بعدی ۲ دقیقه، بدون ذکر دقیقه)، افکت‌های صوتی رویدادها (تنظیمات → ظاهر → صداها)، پالت آرام‌تر و اصلاح خوانایی پوستهٔ روشن.
