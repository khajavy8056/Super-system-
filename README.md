...
## ✨ امکانات (نسخهٔ 1.5.0 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.5.0 (فعلی)** — لایسنس آنلاین با بررسی ۲۴ساعته و قفل برنامه، ویزارد راه‌اندازی اولیهٔ ۱۰مرحله‌ای، لودینگ نصب (۴۵ دقیقه بار اول / ۲ دقیقه بعدی)، نوتیفیکیشن انقضا و لایسنس پایین صفحه (`docs/LICENSING.md`).
