...
| **موبایل / اندروید** | **v2.0: اپ اندروید کاملاً بومی (Java، بدون WebView/PWA)** — `SupermarketMobile-<ver>.apk`، همهٔ ۲۷ بخش ویندوز با UI موبایلی اختصاصی، پایگاه‌دادهٔ SQLite روی گوشی، اسکن دوربین ZXing، جفت‌سازی با QR از تنظیمات ویندوز یا ورود با نام کاربری، حالت مستقل بدون رایانه، و همگام‌سازی خودکار دوطرفهٔ داده در LAN بدون اینترنت ([`docs/ANDROID_CHECKLIST.md`](docs/ANDROID_CHECKLIST.md)). پنل وب موبایل (`/m`) برای مرورگر همچنان در دسترس است |
...
- **v1.9.0 (فعلی)** — اندروید = تمام ۱۶ بخش ویندوز با پوستهٔ موبایل (تب‌بار، کشو، کارت‌ها، bottom-sheet، اسکنر شناور)، اتصال خودکار با توکن جفت‌سازی، همگام لحظه‌ای دوطرفه (یک پایگاه‌داده)، عقب‌نشینی خودکار به حالت آفلاین گوشی. APK: `releases/android/SupermarketMobile-1.9.0.apk`.
