...
## ✨ امکانات (نسخهٔ 1.7.0 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.7.0 (فعلی)** — درخواست پشتیبانی داخل برنامه (ویندوز و گوشی، با موقعیت مکانی و صف ارسال)، همگام‌سازی اینترنتی اختیاری از راه Google Drive (پوشهٔ خصوصی برنامه، Device Flow)، برابری کامل امکانات در اپ اندروید (۲۴ صفحهٔ «بیشتر»)، QR جفت‌سازی در مرورگر، صفحهٔ اتصال گوشی پس از اولین ورود. مستندات: `docs/SUPPORT.md`, `docs/CLOUD_SYNC.md`.
