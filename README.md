...
## ✨ امکانات (نسخهٔ 1.2.4 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.4 (فعلی)** — رفع توقف مرحلهٔ PyInstaller در سازندهٔ نصب‌کننده (stderr زیر حالت Stop در PowerShell 5.1)؛ فقط کد خروج معیار است.
