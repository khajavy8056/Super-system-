...
## ✨ امکانات (نسخهٔ 1.2.2 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.2 (فعلی)** — سازندهٔ نصب‌کننده پایتون نصب‌شده را از رجیستری/py launcher/PATH/پوشه‌های استاندارد پیدا می‌کند و بی‌جهت دانلود نمی‌کند؛ نصب خودکار در مسیر ثابت و بدون نیاز به ریستارت.
