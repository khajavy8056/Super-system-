...
## ✨ امکانات (نسخهٔ 1.3.0 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.3.0 (فعلی)** — تقویم شمسی در همهٔ فیلدهای تاریخ، طراحی جدید «ورود کالا» با پیشنهاد زنده (بدون قیمت تأمین‌کننده)، زمان‌بندی انبارگردانی + هشدار + ویزارد شمارش، تم حرفه‌ای، پنجرهٔ بومی WebView2 در ویندوز.
