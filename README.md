...
## ✨ امکانات (نسخهٔ 1.4.1 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.4.1 (فعلی)** — رفع شکست ساخت نصب‌کننده وقتی pypi.org در دسترس نیست (pywebview اختیاری شد، retry/آینه/wheel آفلاین).
