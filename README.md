...
## ✨ امکانات (نسخهٔ 1.2.6 — وضعیت تک‌به‌تک ۳۵۰ قابلیت: [`docs/FEATURE_CHECKLIST_350.md`](docs/FEATURE_CHECKLIST_350.md))
...
- **v1.2.6 (فعلی)** — رفع شروع بی‌صدای برنامهٔ نصب‌شده (stdout=None در حالت بدون کنسول)؛ پیام خطای فارسی برای هر شکست سرور؛ تک‌نمونه.
