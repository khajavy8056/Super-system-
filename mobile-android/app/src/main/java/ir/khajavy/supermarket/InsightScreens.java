...
public final class InsightScreens {
    ...
    static final String[][] GROUPS = {
        {"customer", "رفتار مشتری", "VIP,CHURN,VISIT_PATTERN,PAY_CYCLE,CUST_FAVORITE,CUST_ITEM_DUE,TICKET_DROP,FREQ_DROP,NEW_CUST_2ND,OFFER_SENSITIVE,CATEGORY_GAP,CREDIT_RISK,ANNIVERSARY,BULK_BUYER,THRESHOLD_UPSELL,CUST_RFM,CUST_CONCENTRATION,CUST_LOYALTY_GAP,CUST_RETURN_ABUSE,NO_DISCOUNT_NEEDED,DISCOUNT_DEPENDENCY,GOLDEN_HOUR,PRICE_PRESSURE,NEXT_BEST_ACTION"},
        {"stock", "انبار و پیش‌بینی", "VELOCITY,EXPIRY_LADDER,DEAD_STOCK,SUPPLIER,REORDER_POINT,OVERSTOCK,STOCKOUT_HISTORY,TREND_UP,TREND_DOWN,EXPIRY_RISK_BUY,WASTE_PATTERN,SHRINKAGE,CATEGORY_TURNS,FIFO_BREAK,SUPPLIER_LEAD,SEASONAL_YOY,ABC_DRIFT,SUPPLIER_CONCENTRATION,STOCKOUT_COST"},
        {"price", "قیمت و سود", "PRICE_GAP,PROFIT_PARETO,NEGATIVE_MARGIN,DISCOUNT_LEAK,PRICE_ROUNDING,ELASTICITY,CATEGORY_MARGIN,MARGIN_EROSION,PROMO_DEPTH,SUBSTITUTION_PAIR"},
        ...
        {"growth", "رشد و بازاریابی", "CROSS_SELL,BASKET_NUDGE,SEASON,CAMPAIGN_FATIGUE,UNREGISTERED_SALES,HERO_PRODUCT,SLOW_DAY,BASKET_TREND,NEW_PRODUCT_WATCH,CATEGORY_DEPTH,LOST_OPPORTUNITY,GATEWAY_PRODUCT,SUBSTITUTE"},
