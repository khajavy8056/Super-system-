...
#:
#: §12 requires at least: عدد، گرم، کیلوگرم، میلی‌گرم، میلی‌لیتر، لیتر، متر.
#: میلی‌گرم was missing — saffron, spices and pharmacy-adjacent lines are sold
#: by the gram or less, and without the unit the operator was forced to record
#: a 0.25 g portion as "0 گرم". The list stays open: POST /api/units adds more
#: without a migration, which is what makes the unit architecture extensible.
